 ...
 * ReAct 场景测试的共享断言工具。
 */
public final class ReActScenarioSupport {

    private ReActScenarioSupport() {
    }

    /** 返回所有 call_tool 步骤。 */
    public static List<ReActStep> toolCallSteps(ReActResult result) {
